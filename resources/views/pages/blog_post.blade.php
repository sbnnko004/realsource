...
<head>
  ...
  <title>What is realsource.co.za. all about?</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
	<a class="navbar-brand" href="{{ route('blog') }}"><img id="logo"  height="42" width="auto" src="{{ URL::asset('assets/img/logo.jpg') }}"></a>
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="post-heading">
            <h1>{{$post->title}}</h1>
            <h2 class="subheading">{{$post->headline}}</h2>
            <span class="meta">Posted by
              <a href="#">{{$post->user->name}}</a>
              on {{(new DateTime($post->updated_at))->format('F d, Y')}}</span>
          </div>
        </div>
      </div>
    </div>
